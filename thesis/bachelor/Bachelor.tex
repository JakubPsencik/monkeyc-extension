...
\input{Chapters/1_Uvod.tex}
\input{Chapters/2_JazykMonkeyC.tex}
\input{Chapters/3_ProblematikaVyvojeRozsireni.tex}
\input{Chapters/4_Syntakticka&SemantickaAnalyzaKodu.tex}
\input{Chapters/5_Navrh&Implementace.tex}
\input{Chapters/6_TestovaniVyslednehoReseni.tex}
\input{Chapters/7_zaver.tex}
